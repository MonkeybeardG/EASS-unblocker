...
// Splash texts
const SplashT = [
  "ohio.69.mu's big brother",
  "ohio.69.mu had over 400 daily users",
  "Made by Carter",
  "Made by Monkeybeard",
  "Thanks for using the site",
  "Made by Monkeybeard Gaming",
  "Subscribe to us on YouTube (@monkeybeardgaming)",
  "Subscribe to my Youtube (@monkeybeardgaming)",
